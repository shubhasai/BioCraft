...
import com.shubhasai.biocraft.databinding.FragmentDevgeniusBinding
...
class DevgeniusFragment : Fragment(), EducationAdapter.EdcDelClicked, WorkExperienceAdapter.WorkDelClicked
    ...
    private lateinit var binding: FragmentDevgeniusBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDevgeniusBinding.inflate(layoutInflater)
...
// Create each page
        ...
        try {
            ...
            if (externalFilesDir != null) {
                Toast.makeText(requireContext(), "PDF saved to ${externalFilesDir.absoluteFile}", Toast.LENGTH_LONG).show()
            }
        } catch (e: IOException) {
            e.printStackTrace()
